...
public class habitacionDoble extends tipoHab {
    ...
    public habitacionDoble(int cantCamas, double precioNoch, String tipoCamas, String tipohab, int cantPerMax, boolean estado) {
    ...
    public habitacionDoble(int cantCamas, double precioNoch, String tipoCamas, String tipohab, int idHabitacion, int cantPerMax, boolean estado) {
